...
{
    public class GetTaskTypesWithPaginationQueryValidator : AbstractValidator<GetTaskTypesWithPaginationQuery>
    {
        public GetTaskTypesWithPaginationQueryValidator()
        {
