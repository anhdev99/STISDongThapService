...
{
    public class GetPositionsWithPaginationQueryValidator : AbstractValidator<GetPositionsWithPaginationQuery>
    {
        public GetPositionsWithPaginationQueryValidator()
        {
