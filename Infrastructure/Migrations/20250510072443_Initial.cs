    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoverningAgencies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagementLevelId = table.Column<int>(type: "integer", nullable: true),
                    TaskTypeId = table.Column<int>(type: "integer", nullable: true),
                    ProjectLeaderId = table.Column<int>(type: "integer", nullable: true),
                    HostOrganizationId = table.Column<int>(type: "integer", nullable: true),
                    GoverningAgencyId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_GoverningAgencies_GoverningAgencyId",
                        column: x => x.GoverningAgencyId,
                        principalTable: "GoverningAgencies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projects_HostOrganizations_HostOrganizationId",
                        column: x => x.HostOrganizationId,
                        principalTable: "HostOrganizations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projects_ManagementLevels_ManagementLevelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_GoverningAgencyId",
                table: "Projects",
                column: "GoverningAgencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_HostOrganizationId",
                table: "Projects",
                column: "HostOrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_ManagementLevelId",
                table: "Projects",
